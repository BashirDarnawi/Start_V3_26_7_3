...
| Bundle split | In progress | stage 14 | `studio.js` passed its 1 MiB cap after stage 14; the Pages screen moves to `studio-pages.js` (one named-bundle loader serves both extra bundles) |
