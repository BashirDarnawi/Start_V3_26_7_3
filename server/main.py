...
@app.get("/studio-staff.js")
def serve_studio_staff_script(request: Request):
...
_AD_CAMPAIGN_FIELDS_CTX = {
    ...
    "allowed_fields": AD_CAMPAIGN_ALLOWED_FIELDS,
}
_validate_ad_campaign_image_source = validate_ad_campaign_image_source


def _prepare_ad_campaign_fields(
    raw_data: Any, *, strict: bool, reject_unknown: bool = False, trusted_media: bool = False
) -> dict[str, Any]:
    return prepare_ad_campaign_fields(
        raw_data, strict=strict, reject_unknown=reject_unknown,
        trusted_media=trusted_media, ctx=_AD_CAMPAIGN_FIELDS_CTX,
    )
